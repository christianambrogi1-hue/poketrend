...
const series = JSON.parse(fs.readFileSync(path.join(ROOT, 'web/data/series.json'))).series;
...
ok('serie non oltre 31 punti', Object.values(series).every((h) => h.length <= 31));
